...
export const metadata: Metadata = {
  title: 'Make Product Photo White Background',
  description: 'Create clean white background product images for marketplaces and online stores.',
  alternates: { canonical: '/make-product-photo-white-background' },
  openGraph: { title: 'Make Product Photo White Background', description: 'Create clean white background product images for marketplaces and online stores.', url: 'https://imagetoolss.com/make-product-photo-white-background' },
}
