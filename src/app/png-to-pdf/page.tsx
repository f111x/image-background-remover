...
export const metadata: Metadata = {
  ...
  description: 'Convert PNG images into PDF documents online for free.',
  alternates: { canonical: '/png-to-pdf' },
  openGraph: { title: 'PNG to PDF Converter Online', description: 'Convert PNG images into PDF documents online for free.', url: 'https://imagetoolss.com/png-to-pdf' },
}
