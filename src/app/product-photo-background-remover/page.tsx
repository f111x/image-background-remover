...
export const metadata: Metadata = {
  ...
  description: 'Remove backgrounds from product photos for ecommerce listings, ads, and catalogs.',
  alternates: { canonical: '/product-photo-background-remover' },
  openGraph: { title: 'Product Photo Background Remover', description: 'Remove backgrounds from product photos for ecommerce listings, ads, and catalogs.', url: 'https://imagetoolss.com/product-photo-background-remover' },
}
