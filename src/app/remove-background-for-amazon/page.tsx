...
export const metadata: Metadata = {
  title: 'Remove Background for Amazon Product Images',
  description: 'Make product photos ready for Amazon-style white background listings.',
  alternates: { canonical: '/remove-background-for-amazon' },
  openGraph: { title: 'Remove Background for Amazon Product Images', description: 'Make product photos ready for Amazon-style white background listings.', url: 'https://imagetoolss.com/remove-background-for-amazon' },
}
