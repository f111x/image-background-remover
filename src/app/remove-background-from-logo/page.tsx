...
export const metadata: Metadata = {
  ...
  description: 'Make logo backgrounds transparent online and download clean design assets.',
  alternates: { canonical: '/remove-background-from-logo' },
  openGraph: { title: 'Remove Background from Logo', description: 'Make logo backgrounds transparent online and download clean design assets.', url: 'https://imagetoolss.com/remove-background-from-logo' },
}
