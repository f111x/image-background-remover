...
export const metadata: Metadata = {
  ...
  description: 'Remove or replace PNG image backgrounds online.',
  alternates: { canonical: '/remove-background-from-png' },
  openGraph: { title: 'Remove Background from PNG', description: 'Remove or replace PNG image backgrounds online.', url: 'https://imagetoolss.com/remove-background-from-png' },
}
