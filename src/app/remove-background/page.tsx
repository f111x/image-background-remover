...
export const metadata: Metadata = {
  ...
  description: 'Remove image backgrounds automatically and download clean transparent results in seconds.',
  alternates: { canonical: '/remove-background' },
  openGraph: { title: 'Remove Background from Image Online', description: 'Remove image backgrounds automatically and download clean transparent results in seconds.', url: 'https://imagetoolss.com/remove-background' },
}
