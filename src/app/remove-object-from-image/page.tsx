...
export const metadata: Metadata = {
  title: 'Remove Object from Image Online',
  description: 'Remove unwanted objects from photos with AI inpainting.',
  alternates: { canonical: '/remove-object-from-image' },
  openGraph: { title: 'Remove Object from Image Online', description: 'Remove unwanted objects from photos with AI inpainting.', url: 'https://imagetoolss.com/remove-object-from-image' },
}
...
export default function Page() {
  return (
    <Layout>
      ...
      <LandingPage title='Remove Object from Image Online' description='Remove unwanted objects from photos with AI inpainting.' ctaHref='/tools/watermark-remover' ctaLabel='Open Watermark Remover' steps={['Upload your image', 'Mark the watermark or unwanted object', 'Generate a cleaned image']} benefits={['AI-powered inpainting', 'Remove watermarks, text, logos, and objects', 'Browser-based workflow', 'Useful for images you own or can edit']} useCases={['Cleaning draft images', 'Removing unwanted text', 'Fixing product or social images', 'Object cleanup']} faqs={faqs} disclaimer='Only remove watermarks from images you own or have permission to edit.' />
    </Layout>
  )
}
