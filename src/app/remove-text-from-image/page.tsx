...
export const metadata: Metadata = {
  title: 'Remove Text from Image Online',
  description: 'Remove unwanted text from images with AI-powered cleanup.',
  alternates: { canonical: '/remove-text-from-image' },
  openGraph: { title: 'Remove Text from Image Online', description: 'Remove unwanted text from images with AI-powered cleanup.', url: 'https://imagetoolss.com/remove-text-from-image' },
}
...
export default function Page() {
  return (
    <Layout>
      ...
      <LandingPage title='Remove Text from Image Online' description='Remove unwanted text from images with AI-powered cleanup.' ctaHref='/tools/watermark-remover' ctaLabel='Open Watermark Remover' steps={['Upload your image', 'Mark the watermark or unwanted object', 'Generate a cleaned image']} benefits={['AI-powered inpainting', 'Remove watermarks, text, logos, and objects', 'Browser-based workflow', 'Useful for images you own or can edit']} useCases={['Cleaning draft images', 'Removing unwanted text', 'Fixing product or social images', 'Object cleanup']} faqs={faqs} disclaimer='Only remove watermarks from images you own or have permission to edit.' />
    </Layout>
  )
}
