...
export const metadata: Metadata = {
  ...
  description: 'Create transparent image backgrounds online with an AI background remover.',
  alternates: { canonical: '/transparent-background' },
  openGraph: { title: 'Make Image Background Transparent', description: 'Create transparent image backgrounds online with an AI background remover.', url: 'https://imagetoolss.com/transparent-background' },
}
