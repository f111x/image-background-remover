...
export const metadata: Metadata = {
  ...
  description: 'Remove watermarks, text, logos, and unwanted objects from images you own or can edit.',
  alternates: { canonical: '/watermark-remover' },
  openGraph: { title: 'AI Watermark Remover Online', description: 'Remove watermarks, text, logos, and unwanted objects from images you own or can edit.', url: 'https://imagetoolss.com/watermark-remover' },
}
...
export default function Page() {
  return (
    <Layout>
      ...
      <LandingPage title='AI Watermark Remover Online' description='Remove watermarks, text, logos, and unwanted objects from images you own or can edit.' ctaHref='/tools/watermark-remover' ctaLabel='Open Watermark Remover' steps={['Upload your image', 'Mark the watermark or unwanted object', 'Generate a cleaned image']} benefits={['AI-powered inpainting', 'Remove watermarks, text, logos, and objects', 'Browser-based workflow', 'Useful for images you own or can edit']} useCases={['Cleaning draft images', 'Removing unwanted text', 'Fixing product or social images', 'Object cleanup']} faqs={faqs} disclaimer='Only remove watermarks from images you own or have permission to edit.' />
    </Layout>
  )
}
