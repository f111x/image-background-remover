...
const translations = {
  en: {
    ...
    editor_prompt_placeholder: "A futuristic city powered by nano-technology, golden hour lighting, ultra detailed...",
    ...
    faq_upgrade_paid_a: "Paid features are coming soon. You'll be able to upgrade with one click in your profile center, with support for WeChat Pay and Alipay.",
    ...
    faq_can_refund_a: "Paid features are coming soon. Full refunds available within 7 days of purchase for any issues.",
    ...
    faq_formats_a: "We support JPG, JPEG, PNG, and WEBP formats. Images must be under 5MB.",
  ...
  zh: {
    ...
    editor_prompt_placeholder: "一座由纳米技术构建的未来城市，黄金时刻的照明，超高细节...",
